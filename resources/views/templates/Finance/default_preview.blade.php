...
<div class="preview_component_pdf">
    <div style="background-color: #ffffff; padding: 10px; display: flex; align-items: center; justify-content: space-between; z-index:0">
        ...
        <img style="margin: 2px; filter: drop-shadow(0px 0px 10px #93ccc6); z-index: 1 !important;"  src="{{ asset('img/PDF/logo.png')}}" alt="books" width="auto" height="80px" class="h-20">
    </div>
    <!-- end header -->
